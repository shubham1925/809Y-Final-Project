...
WorkspacePath          :=/home/kartik/Documents/FinalProjectGroup5
ProjectPath            :=/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5
...
../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedTracked_landbasedtracked.cpp$(ObjectSuffix): src/LandBasedTracked/landbasedtracked.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedTracked_landbasedtracked.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/LandBasedTracked/landbasedtracked.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_LandBasedTracked_landbasedtracked.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedWheeled_landbasedwheeled.cpp$(ObjectSuffix): src/LandBasedWheeled/landbasedwheeled.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedWheeled_landbasedwheeled.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/LandBasedWheeled/landbasedwheeled.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_LandBasedWheeled_landbasedwheeled.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/src_Maze_maze.cpp$(ObjectSuffix): src/Maze/maze.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_Maze_maze.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/Maze/maze.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Maze_maze.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedRobot_landbasedrobot.cpp$(ObjectSuffix): src/LandBasedRobot/landbasedrobot.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_LandBasedRobot_landbasedrobot.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/LandBasedRobot/landbasedrobot.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_LandBasedRobot_landbasedrobot.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Final-Project-Group5/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/src_API_api.cpp$(ObjectSuffix): src/API/api.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_API_api.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/API/api.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_API_api.cpp$(ObjectSuffix) $(IncludePath)
...
../build-$(ConfigurationName)/Final-Project-Group5/src_Algorithm_algorithm.cpp$(ObjectSuffix): src/Algorithm/algorithm.cpp ../build-$(ConfigurationName)/Final-Project-Group5/src_Algorithm_algorithm.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/kartik/Documents/FinalProjectGroup5/Final-Project-Group5/src/Algorithm/algorithm.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Algorithm_algorithm.cpp$(ObjectSuffix) $(IncludePath)
